...
a persistence unit "demo63PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demo63/pom.xml":
...
artifact ("demo63.war") is already built. You can build
